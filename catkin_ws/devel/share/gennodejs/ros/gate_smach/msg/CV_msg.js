...
class CV_msg {
  ...
  static datatype() {
    ...
    return 'gate_smach/CV_msg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f97c3665b94139c47928a4e2b9761f46';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CV_msg(null);
